      ...
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          ...
          <form method = 'POST' action = 'search.php'>
            <input type="text" placeholder = " search the name of the book in this page..." id = "search" name = "search" style = "width:500px;">
            <input class = "button"  type = "submit" value = "Search" /><br>
            <a class="nav-link" href="about.html">About</a>
          </form> -->
          <!-- ISBN -->
          <form method = 'POST' action = 'searchISBN.php'>
              <input type='text' placeholder = ' search the ISBN of the book in this page...' id = 'search' name = 'search' style = 'width:500px;'>
              <input class = 'button'  type = 'submit' value = 'Search' />
              </form>
              <a class="nav-link" href="Library.php" style = "font-size:13px; color:#2626FF; text-decoration:underline;">Use the book name to search</a>
          <!-- end of search -->
          <?php
            ...
            if (mysqli_num_rows($con) > 0) {
              ...
              while($row = mysqli_fetch_assoc($con)) {
                echo "<hr>"."<div style='float: left;'>"."<img src='http://192.168.43.181/final_project/".$row["photo"]."' width:'100px' height='100px'>"."</div>"."<div >";
